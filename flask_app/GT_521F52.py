...
class PyFingerprint_GT_521F52(object):
    ...
    def change_Baud_Rate(self, new_Baud):
        ...
        if not (
                new_Baud % 9600 == 0 and new_Baud != 28800 and new_Baud != 48000 and new_Baud != 67200 and new_Baud != 76800 and new_Baud != 86400 and new_Baud != 96000 and new_Baud != 105600):
        ...
        elif (response_packet.response == 0x31 and response_packet.parameter == response_packet.error_response_dict[
    ...
    def enrollUser(self):
        ...
        print('User enrolled at: {}'.format(n))
        return n
